...
func TestRegisterConnHandler(t *testing.T) {
	...
	handlerCalled := false
	handler := func(n *Node, p *Packet) (interface{}, error) {
		handlerCalled = true
		return nil, nil
	}
...
func TestDispatchWithNilConnection(t *testing.T) {
	...
	registry.register(msgType, msgHandler{
		...
		replyHandler: func(n *Node, p *Packet) (interface{}, error) {
			connCalled = true
			return nil, nil
		},
	})
...
func TestDispatchNoMatchingHandler(t *testing.T) {
	...
	connCalled := false
	registry.registerHandlerWithReply(msgType, func(n *Node, p *Packet) (interface{}, error) {
		connCalled = true
		return nil, nil
	})
